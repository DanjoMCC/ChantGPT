...
- Include 1 verse, a chorus, a bridge, then a final chorus — keep it short and punchy
...
- Use football references throughout`
  ...
  // Note: ElevenLabs rejects prompts containing real artist/player names,
  // so we use only the style prompt (which Claude generates without names).
  try {
